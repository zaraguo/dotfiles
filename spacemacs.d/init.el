...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(parinfer nodejs-repl all-the-icons)
...
values."
  ...
  (setq-default
   ...
   ;; Example for 5 eecent files and 7 projects: '((recents . 5) (projects . 7))
   ...
   dotspacemacs-themes '(zenburn ample ample-zen)
